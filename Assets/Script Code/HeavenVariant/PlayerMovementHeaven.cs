...
public class PlayerMovementHeaven : MonoBehaviour
{
   ...
   // private bool isWallSliding = false; //use this to freeze player or smth when they hit a wall or smth idk
    ...
    private bool hasHitGroundFirstTime = false;
   ...
   // private bool hasSatDown = false; //for animation
    ...
    [SerializeField] private AudioClip walkSound3;
    ...
    private void HandleMovementInput()
    {
        ...
        if (!onWall() || isGrounded()) moveInput = Input.GetAxis("Horizontal");
